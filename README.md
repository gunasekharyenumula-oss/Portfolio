...
<html lang="en">
 <head>
  ...
  <title>Guna sekhar - Cyber Athlete Portfolio</title>
 ...
 <body>
  ...
  <main><!-- Hero Section -->
   <section class="hero-section">
    <div class="athlete-card neon-glow">
     ...
     <h1 class="athlete-name" id="athlete-name">GUNA SEKHAR</h1>
   ...
   <section class="achievements-section">
    ...
    <div style="max-width: 1000px; margin: 0 auto;">
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://linkedin.com/in/gunasekhar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://github.com/gunasekhar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        💻
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://twitter.com/gunasekhar_sec', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        🐦
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://medium.com/@gunasekhar', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📝
       </div>
      ...
      <div class="achievement-badge" style="cursor: pointer; position: relative;" onclick="window.open('https://youtube.com/@GunasekharCyber', '_blank', 'noopener,noreferrer')">
       <div class="energy-trail"></div>
       <div style="font-size: 2.5rem; margin-bottom: 1rem;">
        📺
       </div>
  ...
  <script>
        ...
        const defaultConfig = {
            ...
            cert4_issuer: "Udemy",
            cert4_date: "2023",
            email: "guna.sekhar@email.com",
            phone: "+91 98765 43210",
            location: "Hyderabad, India",
            linkedin_handle: "@gunasekhar",
            github_handle: "@gunasekhar",
            twitter_handle: "@gunasekhar_sec",
            discord_handle: "gunasekhar#2024",
            medium_handle: "@gunasekhar",
            youtube_handle: "gunasekharCyber"
        };
